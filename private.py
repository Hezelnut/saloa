...
with tab1:
    #harmonize = 융화재
    harmonize_setting = st.multiselect('영지 세팅',('뒤집어요 카드놀이','곡예사의 대기실','찬란한 소원 나무','[실리안] 마성의 상속자','[페일린] 베른 무도회','[니아] 기본 의복'),['여신의 가호','뒤집어요 카드놀이','곡예사의 대기실','찬란한 소원 나무','[실리안] 마성의 상속자','[페일린] 베른 무도회','[니아] 기본 의복'])
