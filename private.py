...
with tab4:
    ...
    if '천공의 문 넬라시아 하드3' not in st.session_state:
        st.session_state['천공의 문 넬라시아 하드3'] = {'명예의 파편':2400,'정제된 파괴강석':75,'정제된 수호강석':150,'찬란한 명예의 돌파석':3,'혼돈의 돌':0.4,'더보기 골드':1100}

    if '영원한 빛의 요람 하드3' not in st.session_state:
        st.session_state['영원한 빛의 요람 하드3'] = {'명예의 파편':3000,'정제된 파괴강석':115,'정제된 수호강석':230,'찬란한 명예의 돌파석':4,'혼돈의 돌':0.6,'더보기 골드':1400}
