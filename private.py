...
st.write('{}분 전에 최신화되었습니다.'.format(time_gap.total_seconds()//60))
...
with tab4:
    ...
    if '아브렐슈드 하드1관문' not in st.session_state:
        st.session_state['아브렐슈드 하드1관문'] = {'컨텐츠 보상':{'명예의 파편':1600,'정제된 파괴강석':24,'정제된 수호강석':48,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.6,'클리어 골드':2500},'더보기':{'명예의 파편':1600,'정제된 파괴강석':24,'정제된 수호강석':48,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.6,'더보기 골드':700}}

    if '아브렐슈드 하드2관문' not in st.session_state:
        st.session_state['아브렐슈드 하드2관문'] = {'컨텐츠 보상':{'명예의 파편':2000,'정제된 파괴강석':36,'정제된 수호강석':72,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.8,'클리어 골드':3000},'더보기':{'명예의 파편':2000,'정제된 파괴강석':36,'정제된 수호강석':72,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.8,'더보기 골드':800}}
    
    if '아브렐슈드 하드3관문' not in st.session_state:
        st.session_state['아브렐슈드 하드3관문'] = {'컨텐츠 보상':{'명예의 파편':1600,'정제된 파괴강석':36,'정제된 수호강석':72,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.6,'클리어 골드':900},'더보기':{'명예의 파편':1600,'정제된 파괴강석':36,'정제된 수호강석':72,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.6,'더보기 골드':900}}

    if '아브렐슈드 하드4관문' not in st.session_state:
        st.session_state['아브렐슈드 하드4관문'] = {'컨텐츠 보상':{'명예의 파편':2000,'정제된 파괴강석':48,'정제된 수호강석':96,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.8,'클리어 골드':1100},'더보기':{'명예의 파편':2000,'정제된 파괴강석':48,'정제된 수호강석':96,'찬란한 명예의 돌파석':1.6,'혼돈의 돌':0.8,'더보기 골드':1100}}

    if '아브렐슈드 하드5관문' not in st.session_state:
        st.session_state['아브렐슈드 하드5관문'] = {'컨텐츠 보상':{'명예의 파편':2400,'정제된 파괴강석':60,'정제된 수호강석':120,'찬란한 명예의 돌파석':2,'혼돈의 돌':0.6,'클리어 골드':1200},'더보기':{'명예의 파편':2400,'정제된 파괴강석':60,'정제된 수호강석':120,'찬란한 명예의 돌파석':2,'혼돈의 돌':0.6,'더보기 골드':1100}}
    
    if '아브렐슈드 하드6관문' not in st.session_state:
        st.session_state['아브렐슈드 하드6관문'] = {'컨텐츠 보상':{'명예의 파편':3000,'정제된 파괴강석':90,'정제된 수호강석':180,'찬란한 명예의 돌파석':3,'혼돈의 돌':1,'클리어 골드':1800},'더보기':{'명예의 파편':3000,'정제된 파괴강석':90,'정제된 수호강석':180,'찬란한 명예의 돌파석':3,'혼돈의 돌':1,'더보기 골드':1400}}

    if '카양겔 하드1관문' not in st.session_state:
        st.session_state['카양겔 하드1관문'] = {'컨텐츠 보상':{'명예의 파편':2000,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':0,'혼돈의 돌':0,'클리어 골드':1000},'더보기':{'명예의 파편':1500,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':3,'혼돈의 돌':0.2,'더보기 골드':700}}

    if '카양겔 하드2관문' not in st.session_state:
        st.session_state['카양겔 하드2관문'] = {'컨텐츠 보상':{'명예의 파편':2000,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':0,'혼돈의 돌':0.2,'클리어 골드':1000},'더보기':{'명예의 파편':1500,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':3,'혼돈의 돌':0.2,'더보기 골드':700}}
        
    if '카양겔 하드3관문' not in st.session_state:
        st.session_state['카양겔 하드3관문'] = {'컨텐츠 보상':{'명예의 파편':2800,'정제된 파괴강석':90,'정제된 수호강석':180,'찬란한 명예의 돌파석':0,'혼돈의 돌':0.2,'클리어 골드':1500},'더보기':{'명예의 파편':2000,'정제된 파괴강석':90,'정제된 수호강석':180,'찬란한 명예의 돌파석':4,'혼돈의 돌':0.2,'더보기 골드':900}}

    if '카양겔 하드4관문' not in st.session_state:
        st.session_state['카양겔 하드4관문'] = {'컨텐츠 보상':{'명예의 파편':4600,'정제된 파괴강석':120,'정제된 수호강석':240,'찬란한 명예의 돌파석':0,'혼돈의 돌':0.6,'클리어 골드':2000},'더보기':{'명예의 파편':2500,'정제된 파괴강석':120,'정제된 수호강석':240,'찬란한 명예의 돌파석':6,'혼돈의 돌':0.6,'더보기 골드':1100}}
    ...
    if '일리아칸 노말2관문' not in st.session_state:
        st.session_state['일리아칸 노말2관문'] = {'컨텐츠 보상':{'명예의 파편':3000,'정제된 파괴강석':160,'정제된 수호강석':320,'찬란한 명예의 돌파석':8,'혼돈의 돌':0.6,'클리어 골드':1750},'더보기':{'명예의 파편':3000,'정제된 파괴강석':160,'정제된 수호강석':320,'찬란한 명예의 돌파석':8,'혼돈의 돌':0.6,'더보기 골드':1100}}
    
    if '일리아칸 노말3관문' not in st.session_state:
        st.session_state['일리아칸 노말3관문'] = {'컨텐츠 보상':{'명예의 파편':4200,'정제된 파괴강석':240,'정제된 수호강석':480,'찬란한 명예의 돌파석':8,'혼돈의 돌':1,'클리어 골드':2250},'더보기':{'명예의 파편':4200,'정제된 파괴강석':240,'정제된 수호강석':480,'찬란한 명예의 돌파석':8,'혼돈의 돌':1,'더보기 골드':1500}}
    ...
    if '일리아칸 하드2관문' not in st.session_state:
        st.session_state['일리아칸 하드2관문'] = {'컨텐츠 보상':{'명예의 파편':4000,'정제된 파괴강석':240,'정제된 수호강석':480,'찬란한 명예의 돌파석':12,'혼돈의 돌':1.4,'클리어 골드':2000},'더보기':{'명예의 파편':4000,'정제된 파괴강석':240,'정제된 수호강석':480,'찬란한 명예의 돌파석':12,'혼돈의 돌':1.4,'더보기 골드':1400}}
    
    if '일리아칸 하드3관문' not in st.session_state:
        st.session_state['일리아칸 하드3관문'] = {'컨텐츠 보상':{'명예의 파편':5500,'정제된 파괴강석':360,'정제된 수호강석':720,'찬란한 명예의 돌파석':18,'혼돈의 돌':1.6,'클리어 골드':3750},'더보기':{'명예의 파편':5500,'정제된 파괴강석':360,'정제된 수호강석':720,'찬란한 명예의 돌파석':18,'혼돈의 돌':1.6,'더보기 골드':1900}}

    if '혼돈의 상아탑 노말1관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말1관문'] = {'컨텐츠 보상':{'명예의 파편':1500,'정제된 파괴강석':80,'정제된 수호강석':160,'찬란한 명예의 돌파석':0,'혼돈의 돌':0,'선명한 지혜의 기운':2,'클리어 골드':1250},'더보기':{'명예의 파편':3000,'정제된 파괴강석':100,'정제된 수호강석':200,'찬란한 명예의 돌파석':2,'혼돈의 돌':0,'선명한 지혜의 기운':2,'더보기 골드':700}}

    if '혼돈의 상아탑 노말2관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말2관문'] = {'컨텐츠 보상':{'명예의 파편':1500,'정제된 파괴강석':80,'정제된 수호강석':160,'찬란한 명예의 돌파석':0,'혼돈의 돌':0,'선명한 지혜의 기운':2,'클리어 골드':1500},'더보기':{'명예의 파편':3000,'정제된 파괴강석':100,'정제된 수호강석':200,'찬란한 명예의 돌파석':2,'혼돈의 돌':0,'선명한 지혜의 기운':2,'더보기 골드':800}}

    if '혼돈의 상아탑 노말3관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말3관문'] = {'컨텐츠 보상':{'명예의 파편':2000,'정제된 파괴강석':100,'정제된 수호강석':200,'찬란한 명예의 돌파석':0,'혼돈의 돌':0,'선명한 지혜의 기운':3,'클리어 골드':2000},'더보기':{'명예의 파편':3000,'정제된 파괴강석':200,'정제된 수호강석':400,'찬란한 명예의 돌파석':2,'혼돈의 돌':0,'선명한 지혜의 기운':3,'더보기 골드':900}}

    if '혼돈의 상아탑 노말4관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말4관문'] = {'컨텐츠 보상':{'명예의 파편':2000,'정제된 파괴강석':100,'정제된 수호강석':200,'찬란한 명예의 돌파석':0,'혼돈의 돌':0,'선명한 지혜의 기운':1,'선명한 지혜의 엘릭서':1,'클리어 골드':2750},'더보기':{'명예의 파편':4500,'정제된 파괴강석':200,'정제된 수호강석':400,'찬란한 명예의 돌파석':3,'혼돈의 돌':0,'선명한 지혜의 기운':1,'선명한 지혜의 엘릭서':1,'더보기 골드':1100}}

    elixer = price('빛나는 지혜의 정수')*6*0.95-250

    if '혼돈의 상아탑 하드1관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 하드1관문'] = {'컨텐츠 보상':{'명예의 파편':1800,'정제된 파괴강석':100,'찬란한 명예의 돌파석':0,'정제된 수호강석':200,'혼돈의 돌':0,'클리어 골드':1500-elixer/2},'더보기':{'명예의 파편':4000,'정제된 파괴강석':150,'정제된 수호강석':300,'찬란한 명예의 돌파석':3,'혼돈의 돌':0,'더보기 골드':1000-elixer/2}}

    if '혼돈의 상아탑 하드2관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 하드2관문'] = {'컨텐츠 보상':{'명예의 파편':1800,'정제된 파괴강석':100,'찬란한 명예의 돌파석':0,'정제된 수호강석':200,'혼돈의 돌':0,'클리어 골드':2000-elixer/2},'더보기':{'명예의 파편':4000,'정제된 파괴강석':150,'정제된 수호강석':300,'찬란한 명예의 돌파석':3,'혼돈의 돌':0,'더보기 골드':1000-elixer/2}}

    if '혼돈의 상아탑 하드3관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 하드3관문'] = {'컨텐츠 보상':{'명예의 파편':2400,'정제된 파괴강석':120,'찬란한 명예의 돌파석':0,'정제된 수호강석':240,'혼돈의 돌':0,'클리어 골드':3000-elixer*3/4},'더보기':{'명예의 파편':5000,'정제된 파괴강석':240,'정제된 수호강석':480,'찬란한 명예의 돌파석':5,'혼돈의 돌':0,'더보기 골드':1500-elixer*3/4}}

    if '혼돈의 상아탑 하드4관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 하드4관문'] = {'컨텐츠 보상':{'명예의 파편':2400,'정제된 파괴강석':120,'찬란한 명예의 돌파석':0,'정제된 수호강석':240,'혼돈의 돌':0,'클리어 골드':4500-elixer/4-price('빛나는 지혜의 정수')*6},'더보기':{'명예의 파편':5500,'정제된 파괴강석':300,'정제된 수호강석':600,'찬란한 명예의 돌파석':7,'혼돈의 돌':0,'더보기 골드':2000-elixer/4-price('빛나는 지혜의 정수')*6}}
