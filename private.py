...
with tab4:
    ...
    if '혼돈의 상아탑 노말1관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말1관문'] = {'명예의 파편':3000,'정제된 파괴강석':100,'찬란한 명예의 돌파석':2,'혼돈의 돌':0,'선명한 지혜의 기운':2,'더보기 골드':700}

    if '혼돈의 상아탑 노말2관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말2관문'] = {'명예의 파편':3000,'정제된 파괴강석':100,'찬란한 명예의 돌파석':2,'혼돈의 돌':0,'선명한 지혜의 기운':2,'더보기 골드':800}

    if '혼돈의 상아탑 노말3관문' not in st.session_state:
        st.session_state['혼돈의 상아탑 노말3관문'] = {'명예의 파편':3000,'정제된 파괴강석':200,'찬란한 명예의 돌파석':2,'혼돈의 돌':0,'선명한 지혜의 기운':3,'더보기 골드':900}
