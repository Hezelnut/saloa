...
with tab5:
    ...
    if '카양겔 하드1관문' not in st.session_state:
        st.session_state['카양겔 하드1관문'] = {'컨텐츠 보상':{'명예의 파편':2500,'정제된 파괴강석':80,'정제된 수호강석':160,'찬란한 명예의 돌파석':0,'혼돈의 돌':0.2,'클리어 골드':1500},'더보기':{'명예의 파편':1500,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':3,'혼돈의 돌':0.2,'더보기 골드':700}}
    ...
    if '카양겔 하드3관문' not in st.session_state:
        st.session_state['카양겔 하드3관문'] = {'컨텐츠 보상':{'명예의 파편':5000,'정제된 파괴강석':150,'정제된 수호강석':300,'찬란한 명예의 돌파석':0,'혼돈의 돌':5.6,'클리어 골드':1500},'더보기':{'명예의 파편':2500,'정제된 파괴강석':120,'정제된 수호강석':240,'찬란한 명예의 돌파석':6,'혼돈의 돌':0.6,'더보기 골드':1100}}
