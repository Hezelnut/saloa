...
with tab4:
    ...
    if '캬양겔 하드1관문' not in st.session_state:
        st.session_state['캬양겔 하드1관문'] = {'명예의 파편':1500,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':3,'혼돈의 돌':0.2,'더보기 골드':700}

    if '캬양겔 하드2관문' not in st.session_state:
        st.session_state['캬양겔 하드2관문'] = {'명예의 파편':1500,'정제된 파괴강석':70,'정제된 수호강석':140,'찬란한 명예의 돌파석':3,'혼돈의 돌':0.2,'더보기 골드':700}
        
    if '캬양겔 하드3관문' not in st.session_state:
        st.session_state['캬양겔 하드3관문'] = {'명예의 파편':2000,'정제된 파괴강석':90,'정제된 수호강석':180,'찬란한 명예의 돌파석':4,'혼돈의 돌':0.2,'더보기 골드':900}

    if '캬양겔 하드4관문' not in st.session_state:
        st.session_state['캬양겔 하드4관문'] = {'명예의 파편':2500,'정제된 파괴강석':120,'정제된 수호강석':240,'찬란한 명예의 돌파석':6,'혼돈의 돌':0.6,'더보기 골드':1100}
